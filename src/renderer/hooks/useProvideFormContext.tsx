...
import { IFormContext } from '../components/forms/FormContext';
...
>(
    ...
    return React.useMemo(
        ...
        [dirtyControls, subscribeCalculation, onSubmit, onCancel, onReset, onInput, register, updateRegistrar, getOutput, getFeedback, getDbField, isShowFeedback, displayFeedback, hideFeedback]
    );
}
