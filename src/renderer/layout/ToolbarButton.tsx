...
export function ToolbarButton({ className, icon, size, title, ...remain }: { icon: IconDefinition; size?: SizeProp; title: string } & React.ButtonHTMLAttributes<HTMLButtonElement>) {
